...
void main(void) {
    ...
    char ssd[4];
    char digits[] = {0xE7, 0x21, 0xCB, 0x6B, 0x2D, 0x6E, 0xEE, 0x23, 0xEF, 0x6F};
    ...
    while (1) {
        ...
        if (mode == 0) {
            if (count < 2500) {
                ssd[1] = digits[hours % 10] | 0x10;
            } else {
                ssd[1] = digits[hours % 10];
            }

            ssd[0] = digits[hours / 10];
            ssd[2] = digits[minutes / 10];
            ssd[3] = digits[minutes % 10];
